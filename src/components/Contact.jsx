    ...
    <section id="contact" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <div className="bg-card p-8 rounded-lg card-shadow border border-border/50">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="p-3 bg-muted rounded-lg text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors hover-lift"
                    title={social.name}
                  >
                    {social.icon}
                  </a>
